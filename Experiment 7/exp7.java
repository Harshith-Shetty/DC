...
public class lamport {
      ...
      public void paint(Graphics g) {
         ...
         for (i = 1; i <= p; i++) {
            for (j = 1; j <= ev[i]; j++) {
               ...
               go.drawString("e" + i + j + "(" + en[i][j] + ")", 50 * j,
                     100 * i - 5);
               h1 = hm.get(k);
               if (h1 != 0) {
                  h11 = h1 / 10;
                  ...
                  drawArrow(go, 50 * h12 + 2, 100 * h11, 50 * j + 2, 100
                        * i);
               }
            }
         }
   ...
   public void calc() {
      ...
      p = sc.nextInt();
      System.out.print("Enter the no of events per process : ");
      for (i = 1; i <= p; i++) {
         ev[i] = sc.nextInt();
      }
